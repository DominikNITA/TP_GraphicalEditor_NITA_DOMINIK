...
public class Ellipse extends Shape{
    public Ellipse(double xStarting, double yStarting, double xEnding, double yEnding, Color fillColor) {
    ...
    @Override
    public Object clone() {
        return new Ellipse(getXStarting(), getYStarting(), getXEnding(), getYEnding(), getFillColor());
    }
}
